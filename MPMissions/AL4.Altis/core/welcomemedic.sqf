...
_imag  = "<img image='textures\intro.jpg' size='10' align='center'/>"; _text = format["<br/><t color='#C5B6B5' size='1.8' align='center'>Welcome %1 to Server Name</t><br/><br/>",ProfileName];  
